var searchtemplate = ''
    ...
    + '            <input v-model="" id="iptSearch" type="text" @change="inputChange" class="w608 h54 lh54 mt8 fl pl30 pr30 fz26" placeholder="产品、场地、案例" />         '
    + '        </div>                                                                                                       '
...
var search = new Vue({
    ...
    methods: {
        changeTab: function (tab) {
            this.showTab = tab || 'product';
        },
        show: function () {
            this.showSearch = true;
            //document.getElementById('iptSearch').focus();//自动设置焦点 TOConfirm
            //$('#iptSearch')[0].focus(); 
        },
