...
var appListProduction = new Vue(
    {
        ...
        methods: {
            ...
            queryDictionaryList: function () {
                var vm = this;
                var url = "../../" + requestUrl.produtionSearchList;// "../../production/produtionSearchList";
                var param = {
                    name: "common"
                };
            ...
            queryProdutionByCondition: function (pageIndex) {
                var vm = this;
                var url = "../../" + requestUrl.queryProdutionByCondition;// "../../production/queryProdutionByCondition";
